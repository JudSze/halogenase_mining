...
from models import db, Enzyme, get_gene_data, get_gene_table_columns
...
def gene_details(gene_name):
    ...
    if not gene_data and columns:
        return render_template('gene_details.html', enzyme=enzyme, gene_data=gene_data, columns=columns, error="No data found for this gene")

    return render_template('gene_details.html', enzyme=enzyme, gene_data=gene_data, columns=columns)
